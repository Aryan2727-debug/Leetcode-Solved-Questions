...
public:
    ...
    Node* cloneGraph(Node* node) {
        ...
        //creating a visited array of type node, size=1000 and all default values=NULL
        vector <Node*> visited(1000 , NULL);
        
        //creating a copy node
        Node* copy = new Node(node->val);
        
        //pushing the copy node in the visited array
        visited[node->val] = copy;
        
        //iterating for all the neighbor nodes
